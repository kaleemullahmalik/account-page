...
},_setPopupVisible:function(x,y){var contentElement=this.get_contentElement();
if(contentElement){contentElement.scrollTop=contentElement.scrollLeft=0;
}this._popupElement.style.zIndex=this._zIndex;
if($telerik.isMobileSafari){if(document.body.scrollTop){y-=window.pageYOffset;
}if(document.body.scrollLeft){x-=window.pageXOffset;
